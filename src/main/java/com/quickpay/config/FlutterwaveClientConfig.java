...
@Slf4j
@Configuration
public class FlutterwaveClientConfig{
    ...
    @Bean
    public FlutterwaveClient createFlutterwaveClient(WebClient.Builder webClientBuilder) {
        ...
        return factory.createClient(FlutterwaveClient.class);
    }
